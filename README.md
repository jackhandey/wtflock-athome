...
- **Interactive Neighborhood Map**: Plot cameras with GPS coordinates, field-of-view cones, and directional flow vectors (_Ingress / Egress / Northbound / Southbound_).
...
2. Add your camera stream details, street GPS coordinates, and directional vector (_Ingress / Egress_).
